...
def main():
    ...
    #Parse the prefix of the server from the arguments
    parser = argparse.ArgumentParser()
    parser.add_argument('prefix', type=str, help='The prefix common to all EPICS variables. Example: H1:SEI-USGS_')
